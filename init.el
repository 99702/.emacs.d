...
;; Load package manager and core settings
...
;; Navigation & Completion packages
...
(load "~/.emacs.d/packages/go/init.el")
(load "~/.emacs.d/packages/clojure/init.el")
(load "~/.emacs.d/packages/common-lisp/init.el")
