...
#s(hash-table size 97 test equal rehash-size 1.5 rehash-threshold 0.8125 data ("org-elpa" ("2023-05-20 09:45:56" nil (:local-repo nil :package "org-elpa" :type git)) "melpa" ("2023-05-20 09:45:56" nil (:type git :host github :repo "melpa/melpa" :build nil :package "melpa" :local-repo "melpa")) "gnu-elpa-mirror" ("2023-05-20 09:45:56" nil (:type git :host github :repo "emacs-straight/gnu-elpa-mirror" :build nil :package "gnu-elpa-mirror" :local-repo "gnu-elpa-mirror")) "nongnu-elpa" ("2023-05-20 09:45:56" nil (:type git :repo "https://git.savannah.gnu.org/git/emacs/nongnu.git" :depth (full single-branch) :local-repo "nongnu-elpa" :build nil :package "nongnu-elpa")) "el-get" ("2023-05-20 09:45:56" nil (:type git :host github :repo "dimitri/el-get" :build nil :files ("*.el" ("recipes" "recipes/el-get.rcp") "methods" "el-get-pkg.el") :flavor melpa :package "el-get" :local-repo "el-get")) "emacsmirror-mirror" ("2023-05-20 09:45:56" nil (:type git :host github :repo "emacs-straight/emacsmirror-mirror" :build nil :package "emacsmirror-mirror" :local-repo "emacsmirror-mirror")) "straight" ("2023-05-20 09:45:56" ("emacs") (:type git :host github :repo "radian-software/straight.el" :files ("straight*.el") :branch "master" :package "straight" :local-repo "straight.el")) "use-package" ("2023-05-20 09:45:56" ("emacs" "bind-key") (:type git :flavor melpa :files (:defaults (:exclude "bind-key.el" "bind-chord.el" "use-package-chords.el" "use-package-ensure-system-package.el") "use-package-pkg.el") :host github :repo "jwiegley/use-package" :package "use-package" :local-repo "use-package")) "bind-key" ("2023-05-20 09:45:56" ("emacs") (:flavor melpa :files ("bind-key.el" "bind-key-pkg.el") :package "bind-key" :local-repo "use-package" :type git :repo "jwiegley/use-package" :host github)) "evil" ("2023-05-20 09:45:57" ("emacs" "goto-chg" "cl-lib") (:type git :flavor melpa :files (:defaults "doc/build/texinfo/evil.texi" (:exclude "evil-test-helpers.el") "evil-pkg.el") :host github :repo "emacs-evil/evil" :package "evil" :local-repo "evil")) "goto-chg" ("2023-05-20 09:45:57" ("emacs") (:type git :flavor melpa :host github :repo "emacs-evil/goto-chg" :package "goto-chg" :local-repo "goto-chg")) "evil-collection" ("2023-05-20 09:45:57" ("emacs" "evil" "annalist") (:type git :flavor melpa :files (:defaults "modes" "evil-collection-pkg.el") :host github :repo "emacs-evil/evil-collection" :package "evil-collection" :local-repo "evil-collection")) "annalist" ("2023-05-20 09:45:57" ("emacs" "cl-lib") (:type git :flavor melpa :host github :repo "noctuid/annalist.el" :package "annalist" :local-repo "annalist.el")) "evil-snipe" ("2023-05-20 09:45:57" ("emacs" "evil" "cl-lib") (:type git :flavor melpa :host github :repo "hlissner/evil-snipe" :package "evil-snipe" :local-repo "evil-snipe")) "evil-mc" ("2023-05-20 09:45:57" ("emacs" "evil" "cl-lib") (:type git :flavor melpa :host github :repo "gabesoft/evil-mc" :package "evil-mc" :local-repo "evil-mc")) "evil-matchit" ("2023-05-20 09:45:57" ("emacs") (:type git :flavor melpa :host github :repo "redguardtoo/evil-matchit" :package "evil-matchit" :local-repo "evil-matchit")) "evil-goggles" ("2023-05-20 09:45:57" ("emacs" "evil") (:type git :flavor melpa :host github :repo "edkolev/evil-goggles" :package "evil-goggles" :local-repo "evil-goggles")) "doom-themes" ("2023-05-20 09:45:58" ("emacs" "cl-lib") (:type git :flavor melpa :files (:defaults "themes/*.el" "themes/*/*.el" "extensions/*.el" "doom-themes-pkg.el") :host github :repo "doomemacs/themes" :package "doom-themes" :local-repo "themes")) "spacemacs-theme" ("2023-05-20 09:45:58" ("emacs") (:type git :flavor melpa :host github :repo "nashamri/spacemacs-theme" :package "spacemacs-theme" :local-repo "spacemacs-theme")) "ef-themes" ("2023-05-20 09:45:58" ("emacs") (:type git :host github :repo "emacs-straight/ef-themes" :files ("*" (:exclude ".git")) :package "ef-themes" :local-repo "ef-themes")) "standard-themes" ("2023-05-20 09:45:58" ("emacs") (:type git :host github :repo "emacs-straight/standard-themes" :files ("*" (:exclude ".git")) :package "standard-themes" :local-repo "standard-themes")) "pulsar" ("2023-05-20 09:45:58" ("emacs") (:type git :host github :repo "emacs-straight/pulsar" :files ("*" (:exclude ".git")) :package "pulsar" :local-repo "pulsar")) "fontaine" ("2023-05-20 09:45:58" ("emacs") (:type git :host github :repo "emacs-straight/fontaine" :files ("*" (:exclude ".git")) :package "fontaine" :local-repo "fontaine")) "tmr" ("2023-05-20 09:45:58" ("emacs" "compat") (:type git :host github :repo "emacs-straight/tmr" :files ("*" (:exclude ".git")) :package "tmr" :local-repo "tmr")) "compat" ("2023-05-20 09:45:58" ("emacs" "seq") (:type git :host github :repo "emacs-straight/compat" :files ("*" (:exclude ".git")) :package "compat" :local-repo "compat")) "all-the-icons" ("2023-05-20 09:45:58" ("emacs") (:type git :flavor melpa :files (:defaults "data" "all-the-icons-pkg.el") :host github :repo "domtronn/all-the-icons.el" :package "all-the-icons" :local-repo "all-the-icons.el")) "dashboard" ("2023-05-20 09:45:58" ("emacs") (:type git :flavor melpa :files (:defaults "banners" "dashboard-pkg.el") :host github :repo "emacs-dashboard/emacs-dashboard" :package "dashboard" :local-repo "emacs-dashboard")) "projectile" ("2023-05-20 09:45:58" ("emacs") (:type git :flavor melpa :host github :repo "bbatsov/projectile" :package "projectile" :local-repo "projectile")) "treemacs" ("2023-05-20 09:45:58" ("emacs" "cl-lib" "dash" "s" "ace-window" "pfuture" "hydra" "ht" "cfrs") (:type git :flavor melpa :files (:defaults "Changelog.org" "icons" "src/elisp/treemacs*.el" "src/scripts/treemacs*.py" (:exclude "src/extra/*") "treemacs-pkg.el") :host github :repo "Alexander-Miller/treemacs" :package "treemacs" :local-repo "treemacs")) "dash" ("2023-05-20 09:45:58" ("emacs") (:type git :flavor melpa :files ("dash.el" "dash.texi" "dash-pkg.el") :host github :repo "magnars/dash.el" :package "dash" :local-repo "dash.el")) "s" ("2023-05-20 09:45:58" nil (:type git :flavor melpa :host github :repo "magnars/s.el" :package "s" :local-repo "s.el")) "ace-window" ("2023-05-20 09:45:58" ("avy") (:type git :flavor melpa :host github :repo "abo-abo/ace-window" :package "ace-window" :local-repo "ace-window")) "avy" ("2023-05-20 09:45:58" ("emacs" "cl-lib") (:type git :flavor melpa :host github :repo "abo-abo/avy" :package "avy" :local-repo "avy")) "pfuture" ("2023-05-20 09:45:58" ("emacs") (:type git :flavor melpa :host github :repo "Alexander-Miller/pfuture" :package "pfuture" :local-repo "pfuture")) "hydra" ("2023-05-20 09:45:58" ("cl-lib" "lv") (:type git :flavor melpa :files (:defaults (:exclude "lv.el") "hydra-pkg.el") :host github :repo "abo-abo/hydra" :package "hydra" :local-repo "hydra")) "lv" ("2023-05-20 09:45:58" nil (:flavor melpa :files ("lv.el" "lv-pkg.el") :package "lv" :local-repo "hydra" :type git :repo "abo-abo/hydra" :host github)) "ht" ("2023-05-20 09:45:58" ("dash") (:type git :flavor melpa :host github :repo "Wilfred/ht.el" :package "ht" :local-repo "ht.el")) "cfrs" ("2023-05-20 09:45:58" ("emacs" "dash" "s" "posframe") (:type git :flavor melpa :host github :repo "Alexander-Miller/cfrs" :package "cfrs" :local-repo "cfrs")) "posframe" ("2023-05-20 09:45:58" ("emacs") (:type git :flavor melpa :host github :repo "tumashu/posframe" :package "posframe" :local-repo "posframe")) "treemacs-projectile" ("2023-05-20 09:45:58" ("emacs" "projectile" "treemacs") (:flavor melpa :files ("src/extra/treemacs-projectile.el" "treemacs-projectile-pkg.el") :package "treemacs-projectile" :local-repo "treemacs" :type git :repo "Alexander-Miller/treemacs" :host github)) "treemacs-icons-dired" ("2023-05-20 09:45:58" ("treemacs" "emacs") (:flavor melpa :files ("src/extra/treemacs-icons-dired.el" "treemacs-icons-dired-pkg.el") :package "treemacs-icons-dired" :local-repo "treemacs" :type git :repo "Alexander-Miller/treemacs" :host github)) "treemacs-evil" ("2023-05-20 09:45:58" ("emacs" "evil" "treemacs") (:flavor melpa :files ("src/extra/treemacs-evil.el" "treemacs-evil-pkg.el") :package "treemacs-evil" :local-repo "treemacs" :type git :repo "Alexander-Miller/treemacs" :host github)) "treemacs-magit" ("2023-05-20 09:45:58" ("emacs" "treemacs" "pfuture" "magit") (:flavor melpa :files ("src/extra/treemacs-magit.el" "treemacs-magit-pkg.el") :package "treemacs-magit" :local-repo "treemacs" :type git :repo "Alexander-Miller/treemacs" :host github)) "magit" ("2023-05-20 09:45:58" ("emacs" "compat" "dash" "git-commit" "magit-section" "transient" "with-editor") (:type git :flavor melpa :files ("lisp/magit*.el" "lisp/git-rebase.el" "docs/magit.texi" "docs/AUTHORS.md" "LICENSE" "Documentation/magit.texi" "Documentation/AUTHORS.md" (:exclude "lisp/magit-libgit.el" "lisp/magit-libgit-pkg.el" "lisp/magit-section.el" "lisp/magit-section-pkg.el") "magit-pkg.el") :host github :repo "magit/magit" :package "magit" :local-repo "magit")) "git-commit" ("2023-05-20 09:45:58" ("emacs" "compat" "transient" "with-editor") (:flavor melpa :files ("lisp/git-commit.el" "lisp/git-commit-pkg.el" "git-commit-pkg.el") :package "git-commit" :local-repo "magit" :type git :repo "magit/magit" :host github)) "transient" ("2023-05-20 09:45:58" ("emacs" "compat") (:type git :flavor melpa :host github :repo "magit/transient" :package "transient" :local-repo "transient")) "with-editor" ("2023-05-20 09:45:58" ("emacs" "compat") (:type git :flavor melpa :host github :repo "magit/with-editor" :package "with-editor" :local-repo "with-editor")) "magit-section" ("2023-05-20 09:45:58" ("emacs" "compat" "dash") (:flavor melpa :files ("lisp/magit-section.el" "lisp/magit-section-pkg.el" "docs/magit-section.texi" "Documentation/magit-section.texi" "magit-section-pkg.el") :package "magit-section" :local-repo "magit" :type git :repo "magit/magit" :host github)) "treemacs-persp" ("2023-05-20 09:45:58" ("emacs" "treemacs" "persp-mode" "dash") (:flavor melpa :files ("src/extra/treemacs-persp.el" "treemacs-persp-pkg.el") :package "treemacs-persp" :local-repo "treemacs" :type git :repo "Alexander-Miller/treemacs" :host github)) "persp-mode" ("2023-05-20 09:45:58" ("emacs") (:type git :flavor melpa :host github :repo "Bad-ptr/persp-mode.el" :package "persp-mode" :local-repo "persp-mode.el")) "marginalia" ("2023-05-20 09:45:58" ("emacs" "compat") (:type git :flavor melpa :host github :repo "minad/marginalia" :package "marginalia" :local-repo "marginalia")) "vterm" ("2023-05-20 09:45:58" ("emacs") (:type git :flavor melpa :files ("CMakeLists.txt" "elisp.c" "elisp.h" "emacs-module.h" "etc" "utf8.c" "utf8.h" "vterm.el" "vterm-module.c" "vterm-module.h" "vterm-pkg.el") :host github :repo "akermu/emacs-libvterm" :package "vterm" :local-repo "emacs-libvterm")) "vterm-toggle" ("2023-05-20 09:45:58" ("emacs" "vterm") (:type git :flavor melpa :host github :repo "jixiuf/vterm-toggle" :package "vterm-toggle" :local-repo "vterm-toggle")) "org" ("2023-05-20 09:45:58" ("emacs") (:type git :repo "https://git.savannah.gnu.org/git/emacs/org-mode.git" :local-repo "org" :depth full :pre-build (straight-recipes-org-elpa--build) :build (:not autoloads) :files (:defaults "lisp/*.el" ("etc/styles/" "etc/styles/*")) :package "org")) "org-bullets" ("2023-05-20 09:45:58" nil (:type git :flavor melpa :host github :repo "integral-dw/org-bullets" :package "org-bullets" :local-repo "org-bullets")) "org-fancy-priorities" ("2023-05-20 09:45:58" nil (:type git :flavor melpa :host github :repo "harrybournis/org-fancy-priorities" :package "org-fancy-priorities" :local-repo "org-fancy-priorities")) "expand-region" ("2023-05-20 09:45:58" nil (:type git :flavor melpa :host github :repo "magnars/expand-region.el" :package "expand-region" :local-repo "expand-region.el")) "which-key" ("2023-05-20 09:45:58" ("emacs") (:type git :flavor melpa :host github :repo "justbur/emacs-which-key" :package "which-key" :local-repo "emacs-which-key")) "vertico" ("2023-05-20 09:45:58" ("emacs" "compat") (:type git :host github :repo "emacs-straight/vertico" :files ("*" (:exclude ".git")) :package "vertico" :local-repo "vertico")) "consult" ("2023-05-20 09:45:58" ("emacs" "compat") (:type git :flavor melpa :host github :repo "minad/consult" :package "consult" :local-repo "consult")) "restclient" ("2023-05-20 09:45:58" nil (:type git :flavor melpa :files ("restclient.el" "restclient-pkg.el") :host github :repo "pashky/restclient.el" :package "restclient" :local-repo "restclient.el")) "orderless" ("2023-05-20 09:45:58" ("emacs") (:type git :flavor melpa :host github :repo "oantolin/orderless" :package "orderless" :local-repo "orderless")) "corfu" ("2023-05-20 09:45:58" ("emacs" "compat") (:type git :host github :repo "emacs-straight/corfu" :files ("*" (:exclude ".git")) :package "corfu" :local-repo "corfu")) "cape" ("2023-05-20 09:45:58" ("emacs" "compat") (:type git :flavor melpa :host github :repo "minad/cape" :package "cape" :local-repo "cape")) "clojure-mode" ("2023-05-20 09:45:58" ("emacs") (:type git :flavor melpa :files ("clojure-mode.el" "clojure-mode-pkg.el") :host github :repo "clojure-emacs/clojure-mode" :package "clojure-mode" :local-repo "clojure-mode")) "clojure-mode-extra-font-locking" ("2023-05-20 09:45:58" ("clojure-mode") (:flavor melpa :files ("clojure-mode-extra-font-locking.el" "clojure-mode-extra-font-locking-pkg.el") :package "clojure-mode-extra-font-locking" :local-repo "clojure-mode" :type git :repo "clojure-emacs/clojure-mode" :host github)) "cider" ("2023-05-20 09:45:58" ("emacs" "clojure-mode" "parseedn" "queue" "spinner" "seq" "sesman") (:type git :flavor melpa :files ("*.el" (:exclude ".dir-locals.el") "cider-pkg.el") :host github :repo "clojure-emacs/cider" :package "cider" :local-repo "cider")) "parseedn" ("2023-05-20 09:45:58" ("emacs" "parseclj" "map") (:type git :flavor melpa :host github :repo "clojure-emacs/parseedn" :package "parseedn" :local-repo "parseedn")) "parseclj" ("2023-05-20 09:45:58" ("emacs") (:type git :flavor melpa :host github :repo "clojure-emacs/parseclj" :package "parseclj" :local-repo "parseclj")) "map" ("2023-05-20 09:45:58" ("emacs") (:type git :host github :repo "emacs-straight/map" :files ("*" (:exclude ".git")) :package "map" :local-repo "map")) "queue" ("2023-05-20 09:45:58" ("cl-lib") (:type git :host github :repo "emacs-straight/queue" :files ("*" (:exclude ".git")) :package "queue" :local-repo "queue")) "spinner" ("2023-05-20 09:45:58" ("emacs") (:type git :host github :repo "emacs-straight/spinner" :files ("*" (:exclude ".git")) :package "spinner" :local-repo "spinner")) "sesman" ("2023-05-20 09:45:58" ("emacs") (:type git :flavor melpa :host github :repo "vspinu/sesman" :package "sesman" :local-repo "sesman"))))
...
Includes an Atom-esque icon theme and highlighting based on filetype.") (register-definition-prefixes "doom-themes-ext-treemacs" '("doom-themes-")) (autoload 'doom-themes-visual-bell-fn "doom-themes-ext-visual-bell" "Blink the mode-line red briefly. Set `ring-bell-function' to this to use it.") (autoload 'doom-themes-visual-bell-config "doom-themes-ext-visual-bell" "Enable flashing the mode-line on error.") (register-definition-prefixes "doom-tokyo-night-theme" '("doom-tokyo-night")) (register-definition-prefixes "doom-tomorrow-day-theme" '("doom-tomorrow-day")) (register-definition-prefixes "doom-tomorrow-night-theme" '("doom-tomorrow-night")) (register-definition-prefixes "doom-vibrant-theme" '("doom-vibrant")) (register-definition-prefixes "doom-wilmersdorf-theme" '("doom-wilmersdorf")) (register-definition-prefixes "doom-xcode-theme" '("doom-xcode")) (register-definition-prefixes "doom-zenburn-theme" '("doom-zenburn")) (provide 'doom-themes-autoloads)) "spacemacs-theme" ((spacemacs-theme-autoloads spacemacs-theme spacemacs-theme-pkg spacemacs-light-theme spacemacs-dark-theme) (register-definition-prefixes "spacemacs-dark-theme" '("spacemacs-dark")) (register-definition-prefixes "spacemacs-light-theme" '("spacemacs-light")) (when load-file-name (add-to-list 'custom-theme-load-path (file-name-as-directory (file-name-directory load-file-name)))) (register-definition-prefixes "spacemacs-theme" '("create-spacemacs-theme" "spacemacs-theme-" "true-color-p")) (provide 'spacemacs-theme-autoloads)) "ef-themes" ((ef-themes-autoloads ef-winter-theme ef-tritanopia-light-theme ef-tritanopia-dark-theme ef-trio-light-theme ef-trio-dark-theme ef-themes ef-symbiosis-theme ef-summer-theme ef-spring-theme ef-night-theme ef-light-theme ef-kassio-theme ef-frost-theme ef-duo-light-theme ef-duo-dark-theme ef-deuteranopia-light-theme ef-deuteranopia-dark-theme ef-day-theme ef-dark-theme ef-cyprus-theme ef-cherie-theme ef-bio-theme ef-autumn-theme \.dir-locals) (put 'ef-autumn 'theme-properties '(:background-mode dark :kind color-scheme :family ef)) (put 'ef-bio 'theme-properties '(:background-mode dark :kind color-scheme :family ef)) (put 'ef-cherie 'theme-properties '(:background-mode dark :kind color-scheme :family ef)) (put 'ef-cyprus 'theme-properties '(:background-mode light :kind color-scheme :family ef)) (put 'ef-dark 'theme-properties '(:background-mode dark :kind color-scheme :family ef)) (put 'ef-day 'theme-properties '(:background-mode light :kind color-scheme :family ef)) (put 'ef-deuteranopia-dark 'theme-properties '(:background-mode dark :kind color-scheme :family ef)) (put 'ef-deuteranopia-light 'theme-properties '(:background-mode light :kind color-scheme :family ef)) (put 'ef-duo-dark 'theme-properties '(:background-mode dark :kind color-scheme :family ef)) (put 'ef-duo-light 'theme-properties '(:background-mode light :kind color-scheme :family ef)) (put 'ef-frost 'theme-properties '(:background-mode light :kind color-scheme :family ef)) (put 'ef-kassio 'theme-properties '(:background-mode light :kind color-scheme :family ef)) (put 'ef-light 'theme-properties '(:background-mode light :kind color-scheme :family ef)) (put 'ef-night 'theme-properties '(:background-mode dark :kind color-scheme :family ef)) (put 'ef-spring 'theme-properties '(:background-mode light :kind color-scheme :family ef)) (put 'ef-summer 'theme-properties '(:background-mode light :kind color-scheme :family ef)) (put 'ef-symbiosis 'theme-properties '(:background-mode dark :kind color-scheme :family ef)) (autoload 'ef-themes-select "ef-themes" "Load an Ef THEME using minibuffer completion.
...
`modus-themes' and `ef-themes' (both by Protesilaos)." t) (autoload 'fontaine-set-face-font "fontaine" "Set font and/or other attributes of FACE.
...
(fn &optional ARG)" t) (define-obsolete-function-alias 'projectile-global-mode 'projectile-mode "1.0") (register-definition-prefixes "projectile" '("??" "compilation-find-file-projectile-find-compilation-buffer" "def-projectile-commander-method" "delete-file-projectile-remove-from-cache" "project")) (provide 'projectile-autoloads)) "dash" ((dash-autoloads dash) (autoload 'dash-fontify-mode "dash" "Toggle fontification of Dash special variables.
...
(fn)" t) (register-definition-prefixes "restclient" '("restclient-")) (provide 'restclient-autoloads)) "orderless" ((orderless-autoloads orderless) (autoload 'orderless-filter "orderless" "Split STRING into components and find entries TABLE matching all.
...
(fn STR)") (register-definition-prefixes "orderless" '("orderless-")) (provide 'orderless-autoloads)) "corfu" ((corfu-autoloads corfu) (autoload 'corfu-mode "corfu" "COmpletion in Region FUnction.
...
(fn &optional ARG)" t) (register-definition-prefixes "corfu" '("corfu-")) (provide 'corfu-autoloads)) "cape" ((cape-autoloads cape cape-keyword cape-char) (autoload 'cape-history "cape" "Complete from Eshell, Comint or minibuffer history.
...
(fn &optional INTERACTIVE)" t) (autoload 'cape-symbol "cape" "Complete Elisp symbol at point.
If INTERACTIVE is nil the function acts like a Capf.
...
(fn &optional INTERACTIVE)" t) (autoload 'cape-super-capf "cape" "Merge CAPFS and return new Capf which includes all candidates.
The function `cape-super-capf' is experimental.

(fn &rest CAPFS)") (autoload 'cape-company-to-capf "cape" "Convert Company BACKEND function to Capf.
...
(fn &rest CAPFS)") (autoload 'cape-interactive-capf "cape" "Create interactive completion function from CAPF.

(fn CAPF)") (autoload 'cape-wrap-buster "cape" "Call CAPF and return a completion table with cache busting.
...
(fn CAPF &optional VALID)") (autoload 'cape-wrap-properties "cape" "Call CAPF and add additional completion PROPERTIES.
...
(fn CAPF LENGTH)") (autoload 'cape-wrap-inside-comment "cape" "Call CAPF only if inside comment.
This function can be used as an advice around an existing Capf.
...
(fn &optional TYPE-OR-OBJECT FPS DELAY)") (register-definition-prefixes "spinner" '("spinner-")) (provide 'spinner-autoloads)) "sesman" ((sesman-autoloads sesman sesman-browser) (autoload 'sesman-start "sesman" "Start a Sesman session." t) (autoload 'sesman-restart "sesman" "Restart sesman session.
